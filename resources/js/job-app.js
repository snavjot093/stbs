angular.module('job-app', ['ngRoute', 'ngLoadingSpinner', 'lz-job.controllers','pay.controllers','payslip.controllers', 'cOrder.controllers','sOrder.controllers', 'searchLiquor.controllers','atList.controllers','whiskey.controllers','rum.controllers','wine.controllers','vodka.controllers',
...
config(['$routeProvider', '$httpProvider', function ($routeProvider, $httpProvider) {
    ...
    $routeProvider.when('/showList',   {templateUrl: 'view/showList.jsp', 	controller: 'showListCtrl'});
